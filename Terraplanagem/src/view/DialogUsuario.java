					...
					for ( int i = 0; i < getTabUsuario().getRowCount(); i++ ) {
						if ( (Boolean) getTabUsuario().getModel().getValueAt( i, 2 ) ) {
							...
							int choice = TaskDialogs.choice( null, "O que voc� gostaria de fazer com o usu�rio " + usuario + "?", "", 1, new CommandLink(
									"Deletar o usu�rio", "Deletar o usu�rio e o mesmo n�o ter mais acesso ao sistema." ), new CommandLink(
									"N�o deletar o usu�rio", "N�o deletar o usu�rio e manter o acesso do mesmo ao sistema" ) );
			...
			btnAlterar.addActionListener( new ActionListener() {
				...
				public void actionPerformed( ActionEvent e ) {
					...
					if ( id != null ) {
						...
						TaskDialogs.inform( DialogUsuario.this, "Selecione um usu�rio!", "Selecione um usu�rio para alter�-lo." );
					}
				}
			} );
		}
