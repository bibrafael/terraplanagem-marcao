...
public class UsuarioDialog extends JDialog {
	...
	public UsuarioDialog() {
		this.setTitle( "Terraplanagem S�o Marcos - Cadastro de Usu�rios" );
		...
		public void actionPerformed( ActionEvent e ) {
			...
			if ( nome.isEmpty() || senha.isEmpty() ) {
				...
				try {
					...
					JOptionPane.showMessageDialog( null, "Usu�rio j� existente!", "Erro", JOptionPane.ERROR_MESSAGE );
	...
	// JOptionPane.showMessageDialog( null, "Usu�rio n�o pode ser nulo!" );
	// } else {
	...
	private class alterarUsuarioListener implements ActionListener {
		...
		public void actionPerformed( ActionEvent e ) {
			if ( id == null || tfNome.getText().isEmpty() ) {
				JOptionPane.showMessageDialog( null, "Selecione um usu�rio para alterar.", "Alerta", JOptionPane.WARNING_MESSAGE );
			} else {
		...
		public void actionPerformed( ActionEvent e ) {
			for ( int i = 0; i < table.getRowCount(); i++ ) {
				if ( (Boolean) table.getModel().getValueAt( i, 2 ) ) {
					...
					int choice = TaskDialogs.choice( null, "O que voc� gostaria de fazer com o usu�rio " + usuario + "?", "", 1, new CommandLink(
							"Deletar o usu�rio", "Deletar o usu�rio e o mesmo n�o ter mais acesso ao sistema." ), new CommandLink( "N�o deletar o usu�rio",
							"N�o deletar o usu�rio e manter o acesso do mesmo ao sistema" ) );
